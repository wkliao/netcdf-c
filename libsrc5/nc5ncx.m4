...
`dnl
int
nc5x_get_$1_$2(const void *xp, $2 *ip)
{
	ix_$1 xx;
	get_ix_$1(xp, &xx);
	*ip = ($2) xx;
...
`dnl
int
nc5x_put_$1_$2(void *xp, const $2 *ip)
{
	ix_$1 xx = (ix_$1)*ip;
	put_ix_$1(xp, &xx);
PUTF_CheckBND($1, $2)
...
static int
nc5x_put_short_schar(void *xp, const schar *ip)
{
	uchar *cp = (uchar *) xp;
	if(*ip & 0x80)
		*cp++ = 0xff;
...
static int
nc5x_put_short_uchar(void *xp, const uchar *ip)
{
	uchar *cp = (uchar *) xp;
	*cp++ = 0;
	*cp = *ip;
...
static int
nc5x_put_ushort_schar(void *xp, const schar *ip)
{
	uchar *cp = (uchar *) xp;
	if(*ip & 0x80)
		*cp++ = 0xff;
...
static int
nc5x_put_ushort_uchar(void *xp, const uchar *ip)
{
	uchar *cp = (uchar *) xp;
	*cp++ = 0;
	*cp = *ip;
...
static int
nc5x_put_int_schar(void *xp, const schar *ip)
{
	uchar *cp = (uchar *) xp;
	if(*ip & 0x80)
	{
...
static int
nc5x_put_int_uchar(void *xp, const uchar *ip)
{
	uchar *cp = (uchar *) xp;
	*cp++ = 0x00;
	*cp++ = 0x00;
...
static int
nc5x_put_uint_schar(void *xp, const schar *ip)
{
	uchar *cp = (uchar *) xp;
	*cp++ = 0x00;
	*cp++ = 0x00;
...
static int
nc5x_put_uint_uchar(void *xp, const uchar *ip)
{
	uchar *cp = (uchar *) xp;
	*cp++ = 0x00;
	*cp++ = 0x00;
...
#if X_SIZEOF_FLOAT != SIZEOF_FLOAT || defined(NO_IEEE_FLOAT)
static int
nc5x_get_float_float(const void *xp, float *ip)
{
	/* TODO */
	get_ix_float(xp, ip);
	return NC_NOERR;
...
#if X_SIZEOF_FLOAT != SIZEOF_FLOAT || defined(NO_IEEE_FLOAT)
static int
nc5x_put_float_float(void *xp, const float *ip)
{
	put_ix_float(xp, ip);
#ifdef NO_IEEE_FLOAT
...
static int
nc5x_get_double_float(const void *xp, float *ip)
{
	double xx;
	get_ix_double(xp, &xx);
	if(xx > FLT_MAX)
...
#if X_SIZEOF_DOUBLE != SIZEOF_DOUBLE  || defined(NO_IEEE_FLOAT)
static int
nc5x_get_double_double(const void *xp, double *ip)
{
	/* TODO */
	get_ix_double(xp, ip);
	return NC_NOERR;
...
static int
nc5x_put_double_float(void *xp, const float *ip)
{
	double xx = (double) *ip;
	put_ix_double(xp, &xx);
...
#if X_SIZEOF_DOUBLE != SIZEOF_DOUBLE  || defined(NO_IEEE_FLOAT)
static int
nc5x_put_double_double(void *xp, const double *ip)
{
	put_ix_double(xp, ip);
#ifdef NO_IEEE_FLOAT
...
/*----< nc5x_get_int64() >--------------------------------------------------*/
int
nc5x_get_int64(const void **xpp, long long *llp)
{
    const uchar *cp = (const uchar *) *xpp;
...
`dnl
int
nc5x_getn_$1_$2(const void **xpp, size_t nelems, $2 *tp)
{
	int status = NC_NOERR;
	$1 *xp = ($1 *)(*xpp);
...
`dnl
int
nc5x_pad_getn_$1_$2(const void **xpp, size_t nelems, $2 *tp)
{
	int status = NC_NOERR;
	size_t rndup = nelems % X_ALIGN;
	$1 *xp = ($1 *) *xpp;
...
nc5x_getn_$1_$2(const void **xpp, size_t nelems, $2 *tp)
{
	...
	{
		const int lstatus = nc5x_get_$1_$1(xp, &xx);
		*tp = ($2)xx;
		if(lstatus != NC_NOERR)
			status = lstatus;
	}
...
#pragma cdir shortloop
  ...
  return nrange == 0 ? NC_NOERR : NC_ERANGE;
	...
	for( ; nelems != 0; nelems--, xp += Xsizeof($1), tp++)
	{
		const int lstatus = nc5x_get_$1_$2(xp, tp);
		if(lstatus != NC_NOERR)
			status = lstatus;
	}
...
`dnl
int
nc5x_putn_$1_$2(void **xpp, size_t nelems, const $2 *tp)
{
	int status = NC_NOERR;
	$1 *xp = ($1 *) *xpp;
...
`dnl
int
nc5x_pad_putn_$1_$2(void **xpp, size_t nelems, const $2 *tp)
{
	int status = NC_NOERR;
	size_t rndup = nelems % X_ALIGN;
	$1 *xp = ($1 *) *xpp;
...
nc5x_putn_$1_$2(void **xpp, size_t nelems, const $2 *tp)
{
	...
	for( ; nelems != 0; nelems--, xp += Xsizeof($1), tp++)
	{
		xx = ($1) *tp;
		{
		int lstatus = nc5x_put_$1_$1(xp, &xx);
		if(lstatus != NC_NOERR)
			status = lstatus;
		}
	}
...
`dnl
  double d;               /* special case for nc5x_putn_int_float */
')dnl
  int nrange = 0;         /* number of range errors */
  int realign = 0;        /* "do we need to fix input data alignment?" */
  long cxp = (long) *((char**)xpp);
...
')dnl
  ...
  return nrange == 0 ? NC_NOERR : NC_ERANGE;
	...
	for( ; nelems != 0; nelems--, xp += Xsizeof($1), tp++)
	{
		int lstatus = nc5x_put_$1_$2(xp, tp);
		if(lstatus != NC_NOERR)
			status = lstatus;
	}
...
int
nc5x_getn_schar_schar(const void **xpp, size_t nelems, schar *tp)
{
	NCX_GETN_Byte_Body
}
dnl NCX_GETN_CHAR(schar, uchar)
int
nc5x_getn_schar_uchar(const void **xpp, size_t nelems, uchar *tp)
{
	NCX_GETN_Byte_Body
}
...
int
nc5x_pad_getn_schar_schar(const void **xpp, size_t nelems, schar *tp)
{
	NCX_PAD_GETN_Byte_Body
}
dnl NCX_PAD_GETN_CHAR(schar, uchar)
int
nc5x_pad_getn_schar_uchar(const void **xpp, size_t nelems, uchar *tp)
{
	NCX_PAD_GETN_Byte_Body
}
...
int
nc5x_putn_schar_schar(void **xpp, size_t nelems, const schar *tp)
{
	NCX_PUTN_Byte_Body
}
dnl NCX_PUTN_CHAR(schar, uchar)
int
nc5x_putn_schar_uchar(void **xpp, size_t nelems, const uchar *tp)
{
	NCX_PUTN_Byte_Body
}
...
int
nc5x_pad_putn_schar_schar(void **xpp, size_t nelems, const schar *tp)
{
	NCX_PAD_PUTN_Byte_Body
}
dnl NCX_PAD_PUTN_CHAR(schar, uchar)
int
nc5x_pad_putn_schar_uchar(void **xpp, size_t nelems, const uchar *tp)
{
	NCX_PAD_PUTN_Byte_Body
}
...
int
nc5x_getn_uchar_schar(const void **xpp, size_t nelems, schar *tp)
{
	NCX_GETN_Byte_Body
}
dnl NCX_GETN_CHAR(uchar, uchar)
int
nc5x_getn_uchar_uchar(const void **xpp, size_t nelems, uchar *tp)
{
	NCX_GETN_Byte_Body
}
...
int
nc5x_pad_getn_uchar_schar(const void **xpp, size_t nelems, schar *tp)
{
	NCX_PAD_GETN_Byte_Body
}
dnl NCX_PAD_GETN_CHAR(uchar, uchar)
int
nc5x_pad_getn_uchar_uchar(const void **xpp, size_t nelems, uchar *tp)
{
	NCX_PAD_GETN_Byte_Body
}
...
int
nc5x_putn_uchar_schar(void **xpp, size_t nelems, const schar *tp)
{
	NCX_PUTN_Byte_Body
}
dnl NCX_PUTN_CHAR(uchar, uchar)
int
nc5x_putn_uchar_uchar(void **xpp, size_t nelems, const uchar *tp)
{
	NCX_PUTN_Byte_Body
}
...
int
nc5x_pad_putn_uchar_schar(void **xpp, size_t nelems, const schar *tp)
{
	NCX_PAD_PUTN_Byte_Body
}
dnl NCX_PAD_PUTN_UCHAR(uchar, uchar)
int
nc5x_pad_putn_uchar_uchar(void **xpp, size_t nelems, const uchar *tp)
{
	NCX_PAD_PUTN_Byte_Body
}
...
/* optimized version */
int
nc5x_getn_short_short(const void **xpp, size_t nelems, short *tp)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
nc5x_putn_short_short(void **xpp, size_t nelems, const short *tp)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
nc5x_getn_ushort_ushort(const void **xpp, size_t nelems, unsigned short *tp)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
nc5x_putn_ushort_ushort(void **xpp, size_t nelems, const unsigned short *tp)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
nc5x_getn_int_int(const void **xpp, size_t nelems, int *tp)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
nc5x_putn_int_int(void **xpp, size_t nelems, const int *tp)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
nc5x_getn_uint_uint(const void **xpp, size_t nelems, unsigned int *tp)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
nc5x_putn_uint_uint(void **xpp, size_t nelems, const unsigned int *tp)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
nc5x_getn_float_float(const void **xpp, size_t nelems, float *tp)
{
#ifdef WORDS_BIGENDIAN
...
#elif vax
int
nc5x_getn_float_float(const void **xpp, size_t nfloats, float *ip)
{
...
nc5x_getn_float_float(const void **xpp, size_t nelems, float *tp)
{
	...
	{
		const int lstatus = nc5x_get_float_float(xp, tp);
		if(lstatus != NC_NOERR)
			status = lstatus;
	}
...
/* optimized version */
int
nc5x_putn_float_float(void **xpp, size_t nelems, const float *tp)
{
#ifdef WORDS_BIGENDIAN
...
#elif vax
int
nc5x_putn_float_float(void **xpp, size_t nfloats, const float *ip)
{
...
nc5x_putn_float_float(void **xpp, size_t nelems, const float *tp)
{
	...
	for( ; nelems != 0; nelems--, xp += X_SIZEOF_FLOAT, tp++)
	{
		int lstatus = nc5x_put_float_float(xp, tp);
		if(lstatus != NC_NOERR)
			status = lstatus;
	}
...
/* optimized version */
int
nc5x_getn_double_double(const void **xpp, size_t nelems, double *tp)
{
#ifdef WORDS_BIGENDIAN
...
#elif vax
int
nc5x_getn_double_double(const void **xpp, size_t ndoubles, double *ip)
{
...
nc5x_getn_double_double(const void **xpp, size_t nelems, double *tp)
{
	...
	{
		const int lstatus = nc5x_get_double_double(xp, tp);
		if(lstatus != NC_NOERR)
			status = lstatus;
	}
...
/* optimized version */
int
nc5x_putn_double_double(void **xpp, size_t nelems, const double *tp)
{
#ifdef WORDS_BIGENDIAN
...
#elif vax
int
nc5x_putn_double_double(void **xpp, size_t ndoubles, const double *ip)
{
...
nc5x_putn_double_double(void **xpp, size_t nelems, const double *tp)
{
	...
	for( ; nelems != 0; nelems--, xp += X_SIZEOF_DOUBLE, tp++)
	{
		int lstatus = nc5x_put_double_double(xp, tp);
		if(lstatus != NC_NOERR)
			status = lstatus;
	}
...
/* optimized version */
int
nc5x_getn_int64_longlong(const void **xpp, size_t nelems, long long *tp)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
nc5x_putn_int64_longlong(void **xpp, size_t nelems, const long long *tp)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
nc5x_getn_uint64_ulonglong(const void **xpp, size_t nelems, unsigned long long *tp)
{
#ifdef WORDS_BIGENDIAN
...
/* optimized version */
int
nc5x_putn_uint64_ulonglong(void **xpp, size_t nelems, const unsigned long long *tp)
{
#ifdef WORDS_BIGENDIAN
...
int
nc5x_getn_text(const void **xpp, size_t nelems, char *tp)
{
NCX_GETN_Byte_Body
}

int
nc5x_pad_getn_text(const void **xpp, size_t nelems, char *tp)
{
NCX_PAD_GETN_Byte_Body
}

int
nc5x_putn_text(void **xpp, size_t nelems, const char *tp)
{
NCX_PUTN_Byte_Body
}

int
nc5x_pad_putn_text(void **xpp, size_t nelems, const char *tp)
{
NCX_PAD_PUTN_Byte_Body
}
...
int
nc5x_getn_void(const void **xpp, size_t nelems, void *tp)
{
NCX_GETN_Byte_Body
}

int
nc5x_pad_getn_void(const void **xpp, size_t nelems, void *tp)
{
NCX_PAD_GETN_Byte_Body
}

int
nc5x_putn_void(void **xpp, size_t nelems, const void *tp)
{
NCX_PUTN_Byte_Body
}

int
nc5x_pad_putn_void(void **xpp, size_t nelems, const void *tp)
{
NCX_PAD_PUTN_Byte_Body
}
